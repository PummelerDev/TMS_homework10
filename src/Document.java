...
public class Document {
	...
	public Document(String docNumber) {
		if (toCheck(docNumber) == true) {
			this.docNumber = docNumber;
		} else
			System.out.println("Warning! Entered a wrong number of document!\nIncorrect output is possible!\n");
		this.docNumber = docNumber;
	}

	private boolean toCheck(String docNumber) {
